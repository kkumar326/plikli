<div style="margin:10px 10px 0 10px;">
	<form method="get">
		<input type="hidden" name="widget" value="plikli_news">
		<p>
			{#PLIKLI_News_Widget_Select_Show#}		
			<select name="stories" value="plikli_news" style="width:75px;">
			...
			{#PLIKLI_News_Widget_Select_Items#}
			
			{* <input type="text" name="stories" value="{$news_count}"> *}
		</p>
		<p>
			<input type="submit" class="btn btn-primary" value="{#PLIKLI_News_Widget_Save#}">
		</p>
	</form>
</div>