...
<ul class="breadcrumb">
	...
	{elseif isset($get.search)}<li class="active">{#KLIQQI_Visual_Search_SearchResults#} &quot;{if $get.date && $get.date_to}{$get.date} => {$get.date_to}{elseif $get.date}{$get.date}{else}{$get.search|replace:'/':''}{/if}&quot;{/if}
