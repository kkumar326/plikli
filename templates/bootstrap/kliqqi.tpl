...
<html class="no-js" dir="{#KLIQQI_Visual_Language_Direction#}" xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
<head>
	{checkActionsTpl location="tpl_kliqqi_head_start"}
	
	<!-- START META -->
		{include file=$the_template"/meta.tpl"}
	<!-- END META -->
	
	<link rel="stylesheet" type="text/css" href="{$my_kliqqi_base}/templates/{$the_template}/css/bootstrap.no-icons.min.css">
	<link rel="stylesheet" type="text/css" href="{$my_kliqqi_base}/templates/{$the_template}/css/bootstrap-theme.min.css">
	<link rel="stylesheet" type="text/css" href="{$my_kliqqi_base}/templates/{$the_template}/css/font-awesome.min.css">
	<link rel="stylesheet" type="text/css" href="{$my_kliqqi_base}/templates/{$the_template}/css/jquery.pnotify.css" media="screen" />
	<link rel="stylesheet" type="text/css" href="{$my_kliqqi_base}/templates/{$the_template}/css/style.css" media="screen" />
	{if $Voting_Method eq 2}
		<link rel="stylesheet" type="text/css" href="{$my_kliqqi_base}/templates/{$the_template}/css/star_rating/star.css" media="screen" />
	{/if}
	...
	{checkActionsTpl location="tpl_kliqqi_head_end"}
</head>
<body dir="{#KLIQQI_Visual_Language_Direction#}" {if isset($body_args)}{$body_args}{/if} {checkActionsTpl location="tpl_kliqqi_body_onload"}>
	{if $maintenance_mode eq "true" && $user_level eq 'admin'}
		<div class="alert alert-danger" style="margin-bottom:0;"><button class="close" data-dismiss="alert">&times;</button>{#KLIQQI_Maintenance_Admin_Warning#}</div>
	{/if}
	
	{checkActionsTpl location="tpl_kliqqi_body_start"}
	...
	<div class="container">
		<section id="maincontent">
			<div class="row">
				{checkActionsTpl location="tpl_kliqqi_banner_top"}
			...
			{/if}
					...
					{checkActionsTpl location="tpl_kliqqi_content_start"}
					{checkActionsTpl location="tpl_kliqqi_above_center"}
					
					<!-- START CENTER CONTENT -->
						{include file=$tpl_center.".tpl"}
					<!-- END CENTER CONTENT -->
					
					{checkActionsTpl location="tpl_kliqqi_below_center"}
					{checkActionsTpl location="tpl_kliqqi_content_end"}
				</div><!--/span-->
	  
				{checkActionsTpl location="tpl_kliqqi_columns_start"}	
				...
				{if $pagename neq "submit" && $pagename neq "user" && $pagename neq "profile" && $pagename neq "user_edit" && $pagename neq "register" && $pagename neq "login"}
					...
					<!-- END RIGHT COLUMN -->
				{/if}
			{checkActionsTpl location="tpl_kliqqi_banner_bottom"}
			</div><!--/.row-->
		</section><!--/#maincontent-->
		{if $Auto_scroll != '2'}
			<hr>
	...
	{checkActionsTpl location="tpl_kliqqi_body_end"}
	...
	<!--[if lt IE 7]>
	<script type="text/javascript" src="{$my_kliqqi_base}/templates/{$the_template}/js/jquery/jquery.dropdown.js"></script>
	<![endif]-->
	
	<script type="text/javascript" src="{$my_kliqqi_base}/templates/{$the_template}/js/registration_verify.js"></script>
	<script type="text/javascript" src="{$my_kliqqi_base}/templates/{$the_template}/js/bootstrap.min.js"></script>
    ...
    {if $pagename eq "topusers"}
		<script type="text/javascript" src="{$my_kliqqi_base}/templates/{$the_template}/js/jquery/jquery.tablesorter.js"></script>
		{literal}
			<script type="text/javascript">
				$(function() {	
			...
			<div class="modal-dialog">
				<div class="modal-content">
					<div class="modal-header">
						...
						<h4 class="modal-title">{#KLIQQI_Visual_Login_Title#}</h4>
					</div>
						...
						<div class="control-group">
							<form id="signin" action="{$URL_login}" method="post">
								...
								<div style="login_modal_username">
									<label for="username">{#KLIQQI_Visual_Login_Username#}/{#KLIQQI_Visual_Register_Email#}</label>
								...
								<div class="login_modal_password">
									<label for="password">{#KLIQQI_Visual_Login_Password#}</label>
								...
								<div class="login_modal_remember">
									...
									<div class="login_modal_remember_label">
										<label for="remember" style="">{#KLIQQI_Visual_Login_Remember#}</label>
									</div>
								...
								<div class="login_modal_login">
									...
									<input class="btn btn-primary col-md-12" id="signin_submit" value="{#KLIQQI_Visual_Login_LoginButton#}" tabindex="4" type="submit">
								</div>
								{checkActionsTpl location="tpl_kliqqi_login_link"}
								<hr class="soften" id="login_modal_spacer" />
								<div class="login_modal_forgot">
									<a class="btn btn-default col-md-12" id="forgot_password_link" href="{$URL_login}">{#KLIQQI_Visual_Login_ForgottenPassword#}?</a>
								</div>
	...
	{*if $pagename eq "profile" || $pagename eq "user_edit"*}
		{* Masonry JavaScript *}
		<!--<script type="text/javascript" src="{$my_kliqqi_base}/templates/{$the_template}/js/masonry.min.js"></script> -->	
	{*/if*}
</body>
</html>
