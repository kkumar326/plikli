...
var my_base_url="{$my_base_url}{$my_kliqqi_base}";
var error=false;
	...
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title">{#KLIQQI_Visual_AdminPanel_New_User#}</h4>
			</div>
				...
				<form action="admin_users.php" method="post" id="createUserForm" class="form" onsubmit="return checkValidation()">
					<div class="modal-body">	
						<!-- Form, no buttons (buttons generated by jQuery UI dialog() function) -->
							...
							<label for="username">{#KLIQQI_Visual_Register_Username#}:  ({#KLIQQI_Visual_Register_Error_UserTooShort#})</label>
							...
							{/if}
							<div style="clear:both;"></div>
							<label for="password">{#KLIQQI_Visual_Register_Password#}:  ({#KLIQQI_Visual_Register_Error_FiveCharPass#})</label>
