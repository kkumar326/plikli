<!-- user_disable.tpl -->
<legend>{#KLIQQI_Visual_View_User_Disable#}</legend>
<p>Are you sure you want to "disable" this user and prevent them from logging in?</p>
<p>
	<a class="btn btn-danger" href="{$my_base_url}{$my_kliqqi_base}/admin/admin_users.php?mode=yesdisable&user={$user}{$uri_token_admin_users_disable}">Yes, disable this user.</a>
