...
$navwhere['text2'] = $main_smarty->get_config_vars('KLIQQI_Visual_Breadcrumb_Published');
$navwhere['link2'] = getmyurl('live_published', '');
$main_smarty->assign('navbar_where', $navwhere);
$main_smarty->assign('posttitle', $main_smarty->get_config_vars('KLIQQI_Visual_Breadcrumb_Published'));
