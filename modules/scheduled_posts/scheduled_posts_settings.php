...
define('scheduled_posts_path', my_kliqqi_base . '/modules/scheduled_posts/');
...
//define('scheduled_posts_kliqqi_lang_conf', lang_loc . "/languages/lang_" . kliqqi_language . ".conf");
...
if(isset($main_smarty) && is_object($main_smarty)){
	...
	//$main_smarty->assign('scheduled_posts_kliqqi_lang_conf', scheduled_posts_kliqqi_lang_conf);
