...
define('total_story_views_path', my_kliqqi_base . '/modules/total_story_views/');
...
define('total_story_views_lang_conf', lang_loc . "/modules/total_story_views/lang_" .kliqqi_language. ".conf");

//The Pligg used language file
define('total_story_views_kliqqi_lang_conf', lang_loc . "/languages/lang_" . kliqqi_language . ".conf");
...
if(is_object($main_smarty)){
	...
	$main_smarty->assign('total_story_views_kliqqi_lang_conf', total_story_views_kliqqi_lang_conf);
