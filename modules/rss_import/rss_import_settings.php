...
define('rss_import_path', my_plikli_base . '/modules/rss_import/');
...
define('rss_import_plikli_lang_conf', lang_loc . "/languages/lang_" . plikli_language . ".conf"); 
...
if(is_object($main_smarty)){
	...
	$main_smarty->assign('rss_import_plikli_lang_conf', rss_import_plikli_lang_conf);
