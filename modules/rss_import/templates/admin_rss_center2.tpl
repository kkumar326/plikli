...
{literal}
<script src="./modules/rss_import/js/plikli_effects.js" type="text/javascript"></script>
...
<br />
<img src="{$my_plikli_base}/modules/rss_import/images/feed_add.gif" align="absmiddle"/> 
<a href="{$my_plikli_base}/module.php?module=rss_import">Back to Feeds Lists</a>
...
{foreach from=$FeedList item=feed_id}
	...
	{if $feed_id eq $fid} 
		...
		<br />
		<img src="{$my_plikli_base}/modules/rss_import/images/feed_delete.gif" align="absmiddle"/> <a href="module.php?module=rss_import&action=dropfeed&feed_id={$feed_id}" onClick="return verify()">Delete this feed</a>
		<br />
		<img src="{$my_plikli_base}/modules/rss_import/images/feed_go.gif" align="absmiddle"/> <a href = "module.php?module=rss_import&action=exportfeed&feed_id={$feed_id}">Export this feed</a>
		<br />
		<img src="{$my_plikli_base}/modules/rss_import/images/feed_go.gif" align="absmiddle"/> <a href = "module.php?module=rss_import&action=examinefeed&feed_id={$feed_id}">Examine this feed</a>
		<br />
		<img src="{$my_plikli_base}/modules/rss_import/images/feed_go.gif" align="absmiddle"/> <a href = "module.php?module=rss_import_do_import&override={$feed_id}">Import this feed</a>
		<br /><br />
		...
		<h4>Feed Content</h4>
		<p>Below is where you associate feed fields with plikli fields, which tells the plikli RSS Importer what data should be used where. For example you will want to connect the feed's title value to your plikli link_title value.</p>
		
		<table class="table table-bordered">
			<thead>
				<tr>
					<th>Feed Field Name</th>
					<th>plikli Field Name</th>
					<th>Remove Item</th>
				</tr>
			</thead>
			<tbody>
				{foreach from=$FeedLinks item=feed_link_id}					
					<tr>
						...
						{feedsListplikliLinkFields}
						
						<td><span class="emptytext">{eipItem item=qeip_FeedLink_plikliField unique=$feed_link_id ShowJS=TRUE}</span></td>
