...
define('upload_path', my_plikli_base . '/modules/upload/');
...
define('upload_plikli_lang_conf', lang_loc . "/languages/lang_" . plikli_language . ".conf");
...
"tpl_plikli_story_who_voted_start",
"tpl_plikli_story_who_voted_end",
"tpl_plikli_story_related_start",
"tpl_plikli_story_related_end",
"tpl_plikli_story_comments_start",
"tpl_plikli_story_comments_end"
);


$comment_places = array(
"tpl_plikli_story_comments_single_start",
"tpl_plikli_story_comments_single_end"
);

// don't touch anything past this line.
if(isset($main_smarty) && is_object($main_smarty)){
	$main_smarty->assign('upload_path', upload_path);
	$main_smarty->assign('upload_plikli_lang_conf', upload_plikli_lang_conf);
