...
if(defined('mnminclude')){
	...
	if( do_we_load_module() ) {		
		include_once(mnmmodules . 'upload/upload_main.php');
        	...
        	module_add_action_tpl('tpl_kliqqi_submit_step2_after_form', upload_tpl_path . '/upload_files.tpl');
		...
		if ($settings['allow_comment']) {
		    ...
		    module_add_action('after_comment_edit', 'upload_do_comment_submit','');        		     
        	    module_add_action_tpl('tpl_kliqqi_story_comments_form_end', upload_tpl_path . '/upload_comments.tpl');
		}
	}
