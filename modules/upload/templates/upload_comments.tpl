...
<label for="fileInput" class="control-label">{#KLIQQI_Upload_Attach#}</label>
<p class="help-block">{$upload_extensions} {#KLIQQI_Upload_Extensions_Allowed#}</p>

<script>
var uploading = '<fieldset style="border:1px solid #eee;padding:10px;margin-bottom:10px;font-weight:bold;"><h2>{#KLIQQI_Upload_Uploading#}...</h2></fieldset>';
var failed = '<fieldset style="border:1px solid #eee;padding:10px;margin-bottom:10px;font-weight:bold;"><h2>{#KLIQQI_Upload_Failed#}...</h2></fieldset>';
...
<button class="btn btn-default" onclick='if (upload_fields < {$upload_maxnumber}) add_upload_field({$upload_maxnumber}); if (++upload_fields >= {$upload_maxnumber}) this.disabled=true; return false;' {if $upload_fields>=$upload_maxnumber}disabled{/if}>{#KLIQQI_Upload_Add_File#}</button>
<br />
