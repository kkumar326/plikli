...
define('subscribe2comments_path', my_kliqqi_base . '/modules/subscribe2comments/');
...
define('subscribe2comments_kliqqi_lang_conf', lang_loc . "/languages/lang_" . kliqqi_language . ".conf");
...
if(isset($main_smarty) && is_object($main_smarty)){
	...
	$main_smarty->assign('subscribe2comments_kliqqi_lang_conf', subscribe2comments_kliqqi_lang_conf);
