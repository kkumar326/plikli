<?php	
	...
	$module_info['homepage_url'] = 'http://www.kliqqi.com/mods/anonymous_comments.zip';
	$module_info['requires'][] = array('anonymous', 0.1, 'Anonymous Mode', '');
	//$module_info['requires'][] = array('hc', 1, 'Human Check', '');
	
	//$module_info['db_sql'][] = "INSERT INTO ".table_users." (user_login,user_level,user_modification,user_date,user_pass,user_email,user_lastlogin) VALUES ('anonymous','normal',NOW(),NOW(),'1e41c3f5a260b83dd316809b221f581cdbba8c1489e6d5896', 'anonymous@kliqqi.com',NOW())";
