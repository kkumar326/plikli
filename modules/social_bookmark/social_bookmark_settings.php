...
define('social_bookmark_path', my_kliqqi_base . '/modules/social_bookmark/');
...
define('social_bookmark_kliqqi_lang_conf', lang_loc . "/languages/lang_" . kliqqi_language . ".conf");
...
if(is_object($main_smarty)){
	...
	$main_smarty->assign('social_bookmark_kliqqi_lang_conf', social_bookmark_kliqqi_lang_conf);
}
